...
export const ExperienceTimeline = ({
  ...
  return (
    <section
      ...
      className={cn(
        "relative h-screen overflow-hidden border-y border-foreground/10 bg-[linear-gradient(180deg,rgba(248,250,252,1),rgba(255,255,255,0.96))] px-4 py-16 sm:px-6 lg:px-8 lg:py-24",
        className,
      )}
      id={id}
    >
      <div className="mx-auto max-w-7xl flex flex-col items-end">
        ...
        <ol
          ...
          className="relative w-full h-[50vh] overflow-hidden mt-12 space-y-6 before:absolute before:bottom-24 before:right-3 before:top-0 before:w-px before:bg-linear-to-t before:from-accent/30 before:via-foreground/10 before:to-transparent sm:mt-16 lg:before:right-4"
        >
          <div
            ref={timelineRef}
          ...
          >
            {[...entries].reverse().map((entry, index) => {
              ...
              return (
                <li
                  className="relative h-[50vh] p4-10 sm:pr-12 lg:pr-14 flex flex-col justify-center items-end"

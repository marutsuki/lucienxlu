  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <div
          className={clsx(
            'mx-auto max-w-7xl px-4 py-16 transition-all duration-700 ease-out sm:px-6 lg:px-8 lg:py-20',
        ...
        >
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(19rem,0.8fr)] lg:items-start">
            <div className="space-y-8">
              <div className="space-y-4">
                {about.paragraphs.map((paragraph) => (
                  <p
                    className="max-w-3xl text-base leading-8 text-foreground/72 sm:text-lg"
                    key={paragraph}
                  >
                    {paragraph}
                  </p>
              ...
              <div className="rounded-[2rem] border border-foreground/10 bg-background/80 p-6 shadow-[0_24px_80px_-52px_rgba(15,23,42,0.45)]">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-foreground/62">
                      The areas I reach for most often in product-facing engineering work.
                    </p>
                  </div>
                  <MetadataLine
